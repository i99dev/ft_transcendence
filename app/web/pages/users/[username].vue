    ...
    <div class="bg-gray-50">
        ...
        <div v-if="user == null">
            <div class="justify-center flex min-h-full">
                <img class="py-40 rounded" src="https://media.tenor.com/mpRJETAa-WwAAAAC/chopper-tony-chopper.gif" />
            </div>
            <h1 class="justify-center flex text-3xl font-bold tracking-tight text-center text-blue-900 sm:text-3xl">
