			...
			<form action="#">
				...
				<div class="mt-8 flex justify-center text-lg text-black">
					...
					<div class="rounded-3xl bg-gray-90 bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600">
                         <img src="https://signin.intra.42.fr/assets/42_logo-7dfc9110a5319a308863b96bda33cea995046d1731cebb735e41b16255106c12.svg" v-bind:href="link" v-on:click="go" width="35" height="20" alt="icon">
					</div>
