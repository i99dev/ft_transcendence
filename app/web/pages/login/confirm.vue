<template>
    <div>
        ...
        <div class="centered flex-col h-screen w-full">
            <div class="centered flex-col border border-tertiary shadow-xl shadow-tertiary p-5 rounded-2xl relative"
                style="max-width: 80vw">
                <button class="absolute top-0 left-0 text-white m-2 p-2 rounded-full hover:bg-secondary smooth-transition"
                    @click="() => navigateTo('/login')">
                    <ArrowSmallLeftIcon class="w-8 aspect-square" />
                </button>
                <h1 class="text-white text-xl md:text-2xl lg:text-3xl text-center capitalize p-2 mb-8">
                    Hi
                    <div
                ...
                <h3 v-if="timer" title="expires in"
                ...
                <h2 class="text-white text-md md:text-lg lg:text-xl text-center capitalize p-2">
                    ...
                    <button class="bg-secondary hover:bg-primary smooth-transition rounded-xl p-2 m-2" @click="resendCode">
                        Resend
                    </button>
                </h2>
            </div>
