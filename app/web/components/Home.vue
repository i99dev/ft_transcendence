  ...
  <div>
      ...
      >
          <div class="flex flex-col w-full space-y-6 items-center">
              <UserProfileList
                  :search="true"
                  @selectUser="handleUserSearch($event?.login)"
              />
              ...
              <button
                  ...
                  class="h-10 w-30 hover:scale-125 smooth-transition text-white bg-primary hover:bg-access focus:ring-4 focus:ring-tertiary font-medium rounded-lg text-xl px-5 py-2.5 text-center mr-5 inline-flex items-center"
              >
                  Play
              </button>
              ...
              <div class="flex flex-wrap sm:flex-no-wrap items-center justify-between w-full">
                  ...
                  <div
                      class="w-full sm:w-1/4 rounded-b sm:rounded-b-none shadow bg-white"
                  ></div>
              </div>
              <!-- Acheivement popup -->
              <AchievPoPUp />
