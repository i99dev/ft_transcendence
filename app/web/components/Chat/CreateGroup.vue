                                ...
                                <div class="w-full max-w-sm">
                                        ...
                                        <div class="flex items-center border-b border-indigo-500 py-2">
                                            <div class="file-upload">
                                                ...
                                                <button @click="() => fileInput.click()" type="button"
                                                    ...
                                                    :class="{ 'p-2': !chatImage }">
                                                    <svg v-if="!chatImage" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <input
                                                ...
                                                id="groupChatName" type="text" placeholder="Enter group name"
                                                aria-label="Group Name" v-model="groupChat.name" @keyup.enter="nextStage"
                                                required />
                                        </div>
                                    ...
                                    <form class="chat-form" @submit.prevent="" v-else-if="stage === 2">
                                        <div v-for="user in users" :key="user.id" class="flex-row inline-flex flex-nowrap">
                                            <button
                                                ...
                                                type="button" @click="removeUser(user)">
                                                <img class="rounded-full w-8 h-8 object-cover" :src="user.image"
                                                    :alt="user.username" />
                                    ...
                                    <form class="chat-form" @submit.prevent="" v-else-if="stage === lastStage">
                                        <RadioGroup v-model="groupChat.chatType">
                                            ...
                                            <div class="space-y-2">
                                                <RadioGroupOption as="template" v-for="chatType in chatTypes"
                                                    :key="chatType.type" :value="chatType" v-slot="{ active, checked }">
                                                    <div :class="[
                                                        active
                                                                        ...
                                                                        " class="flex flex-col md:mr-16 my-2">
                                                                            ...
                                                                            <div class="relative">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    id="createGroupPassword" type="password"
                                                                                    v-model="
                                                                                        groupChat.password
                                        ...
                                        <div class="flex justify-end mt-4">
                                            ...
                                            <button
                                                class="flex-shrink-0 bg-indigo-500 hover:bg-indigo-700 border-indigo-500 hover:border-indigo-700 text-sm border-4 text-white py-1 px-2 rounded capitalize focus:outline-indigo-400"
                                                type="button" @click="createGroupChat">
                                                create
                                            </button>
                                        </div>
                                    </form>
