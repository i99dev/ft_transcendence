    ...
    <MainPopup :show="props?.show" @closeMainPopup="closePopup()">
        <form class="chat-form" @submit.prevent="">
            <RadioGroup v-model="groupChatType">
                ...
                <div class="space-y-2">
                    <RadioGroupOption as="template" v-for="chatType in chatTypes" :key="chatType?.type" :value="chatType"
                                            ...
                                            <div v-if="chatType.type === 'PUBLIC'" class="flex flex-col md:mr-16 my-2">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        id="createGroupPassword" type="password" v-model="chatPassword"
            ...
            <div class="flex justify-end mt-4">
                ...
                <button
                    ...
                    type="button" @click="sendChatType">
