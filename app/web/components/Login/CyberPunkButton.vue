<template>
    <div>
        <button
            ...
            <span aria-hidden class="cybr-btn__glitch bg-secondary before:border-r-4 before:border-r-tertiary">{{
                props.buttonName }}_</span>
            <span aria-hidden
                class="absolute -bottom-2 right-2 bg-tertiary group-hover:opacity-80 w-1/6 h-1/4 centered text-sm rounded-sm font-normal">42</span>
        </button>
    </div>
</template>
