            ...
            <div class="sm:w-full w-60 relative">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center mt-14">
                    ...
                    >
                        {{ percentage }}
                        <span
                            class="text-2xl font-medium leading-normal text-center text-gray-500 dark:text-gray-100"
                            >%</span
                        >
                    </p>
                    <p
        ...
        return {
            ...
            chartData: {
                ...
                options: {
                    ...
                    circumference:
                        1 *
                        Math.PI /** put in a much smaller amount  so it does not take up an entire semi circle */,
                    legend: {
                        display: false,
                    },
                    tooltip: {
