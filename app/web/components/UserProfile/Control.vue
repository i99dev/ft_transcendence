<template>
    <div class="m-2 lg:m-0">
        <div v-if="props.isMe && !props.isProfile" class="grid grid-cols-4 lg:grid-cols-6 gap-1 lg:gap-2">
            <button @click="openChatModel" title="Chat"
            ...
            <button @click="openFriendsModel" title="Friends"
            ...
            <button @click="useLogout" title="Logout"
            ...
            <button @click="updateTwoFacAuth" :title="user_info.two_fac_auth ? 'Disable 2FA' : 'Enable 2FA'"
                class="relative hover:bg-primary rounded-full smooth-transition p-2 w-12 aspect-square">
            ...
            <button @click="navigateTo('/help')" title="Help"
                class="relative hover:bg-primary rounded-full smooth-transition p-2 w-12 aspect-square">
            ...
            <button @click="handleMuteSound" :title="muteSound ? 'Mute' : 'Unmute'"
                class="relative hover:bg-primary rounded-full smooth-transition p-2 w-12 aspect-square">
                <svg v-if="muteSound" xmlns="http://www.w3.org/2000/svg" class="fill-white w-8 h-8" viewBox="0 0 16 16">
                    <path
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="fill-white w-8 h-8" viewBox="0 0 16 16">
                    <path
        ...
        <div v-else-if="!props.isMe" class="flex space-x-6">
            <button @click="handleDMUser" :title="`DM '${props.username}'`"
