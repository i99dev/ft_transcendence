                    ...
                    <div class="mt-4 mr-auto mb-4 ml-auto bg-white max-w-lg">
                        <div class="flex flex-col items-center pt-6 pr-6 pb-6 pl-6">
                            ...
                            <form class="mx-5 my-4">
                                ...
                                >
                                    ...
                                    <div class="flex space-x-4">
                                        <a
                                            @click="isUploadingImage"
                                            href="#"
                                            class="h-10 mt-5 w-30 text-white bg-indigo-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center mr-5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
                                            >Upload</a
                                        >
                                        <a
                                            @click="isDefaultImage"
                                            href="#"
                                            class="h-10 mt-5 w-30 text-white bg-indigo-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center mr-5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
                                            >Default</a
                                        >
                                ...
                                <div v-if="isDefault" class="grid grid-cols-4 gap-4 p-4">
                                    <div v-for="(image, index) in defaultImages" :key="index">
                                        <img
                                            class="w-25 h-15 items-center justify-center object-cover rounded-lg hover:shadow-lg"
                                            :src="image"
                            ...
                            <div v-if="isDefault || isUploading" class="flex space-x-4">
                                <a
                                    @click="backtoImageSelection"
                                    href="#"
                                    class="h-10 mb-2 w-30 text-white bg-indigo-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center mr-5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
                                    >Back</a
                                >
                            </div>
                            <div>
