<template>
    ...
    <nav class="w-full mx-auto bg-violet-700 shadow border-b-4 border-solid border-purple-500">
            ...
            <div class="h-full xl:flex items-center justify-end hidden">
                <div class="w-full h-full flex items-center">
                    <div class="w-full h-full flex">
                        <div class="w-32 h-full flex items-center justify-center border-teal-400 border-r text-teal-300 cursor-pointer">
