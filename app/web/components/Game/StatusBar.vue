...
<template>
    <div
        ...
        <div class="flex flex-col items-center text-xl">
            <div class="text-white uppercase overflow-hidden w-24 font-mono text-center">{{playersUsername[0]}}</div>
            <div class="text-white font-semibold text-2xl">{{ playersData[0].score }}</div>
        </div>
        <div class="flex space-x-4">
            <div v-for="(powerUp, i) in playersData[0].powerUps" :key="i"
        ...
        <div class="flex space-x-4">
            <div v-for="(powerUp, i) in playersData[1].powerUps" :key="i"
                class="bg-white w-12 h-12 rounded-md border-2 border-violet-400 flex items-center justify-center relative"
        ...
        <div class="flex flex-col items-center text-xl">
            <div class="text-white uppercase overflow-hidden w-24 font-mono text-center">{{playersUsername[1]}}</div>
