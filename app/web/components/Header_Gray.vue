        ...
        <div class="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div class="h-full flex items-center">
                <div class="mr-10 flex items-center">
                    <h3 class="text-base text-sky-500 font-bold tracking-normal leading-tight ml-3 hidden lg:block">PongPing</h3>
                </div>
            ...
            <div class="h-full xl:flex items-center justify-end hidden">
                <div class="w-full h-full flex items-center">
                    <div class="w-full h-full flex">
                        <div class="w-32 h-full flex items-center justify-center border-sky-300 border-r text-sky-400 cursor-pointer">
                        ...
                        <div class="w-full flex items-center justify-end relative cursor-pointer" @click="dropdownHandler($event)">
                            <ul class="p-2 w-40 border-r bg-white absolute rounded left-0 shadow mt-16 top-0 hidden">
                                <li @click="toggleProfileWindow" class="cursor-pointer text-slate-800 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                ...
                                <li @click="logout" class="cursor-pointer text-slate-800 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                            ...
                            <img class="rounded h-14 w-14 object-cover " :src="profilePhoto" alt="logo" />
            ...
            <div class="flex items-center xl:hidden">
                <ul class="p-2 border-r bg-sky-100 absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16 hidden">
                    <li class="flex md:hidden cursor-pointer text-sky-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        <div class="flex items-center">
                    ...
                    <li class="flex md:hidden flex-col cursor-pointer text-sky-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center">
                        <div class="flex items-center">
                            <span @click="go('Match History')" class="ml-2 font-bold">Match History</span>
                        </div>
                    </li>
                    <li class="border-b border-sky-300 flex md:hidden cursor-pointer text-sky-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                        <span @click="go('Leaderboard')" class="ml-2 font-bold">Leaderboard</span>
                    </li>
                    
                    <li class="cursor-pointer text-sky-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                                <circle cx="12" cy="7" r="4" />
                    ...
                    <li class="cursor-pointer text-sky-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
