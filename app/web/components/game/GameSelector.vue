  ...
  <div
    ...
    <div v-if="step === 2" key="step2">
      ...
      <div v-if="selectedGame === 'custom'">
        <h3 class="text-xl text-bold text-center text-white mt-4 mb-2">Pick Two PowerUps</h3>
        <h3 class="text-s text-white text-center  mb-2">Powerups can be used with buttons 1, 2</h3>
        <div class="grid grid-cols-2 gap-2 text-white">
          <div v-for="(powerup, index) in powerups" :key="index" class="flex items-center">
            <input type="checkbox" :id="powerup" :value="powerup" v-model="selectedPowerups" @change="checkPowerupLimit"
