<template>
    <div>
        <nav class="w-full mx-auto bg-cyan-500 shadow border-b-4 border-solid border-cyan-200">
            <div
                class="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto"
            >
                ...
                <div class="flex items-center xl:hidden">
                    ...
                    >
                        ...
                        <li
                            class="border-b border-sky-300 flex md:hidden cursor-pointer text-sky-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none"
                        >
                            <span @click="go('Leaderboard')" class="ml-2 font-bold"
                                >Leaderboard</span
                            >
                        </li>
