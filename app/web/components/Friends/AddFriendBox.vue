    ...
    <TransitionRoot as="template">
        <Dialog as="div" class="fixed inset-0 z-20 overflow-y-auto">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 transition-opacity" @click="
                    () => {
                        addFriendOpen = false
                    }
                ">
                ...
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0" enter-to="opacity-100"
                    ...
                    <div
                        ...
                        <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mt-2">
                                <input v-model="friendNameToAdd" type="text" placeholder="Enter friend's name"
                        ...
                        <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button @click="addNewFriend" type="button"
