...
export class gameLogic {
    ...
    private emitGameSetup(player1: Socket, player2: Socket, game: gameStatusDto): void {
    ...
    private emitEndGame(client: Socket, event: string): void {
        client.emit(event, this.gameResult)
    }
    ...
    public async endGame(
        ...
        this.emitEndGame(client, isWinner ? 'Game-Over' : 'End-Game')
